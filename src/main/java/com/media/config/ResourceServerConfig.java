...
public class ResourceServerConfig extends ResourceServerConfigurerAdapter {
    ...
    public void configure(HttpSecurity http) throws Exception {
        http.requestMatchers()
                .and()
                .authorizeRequests()
                .antMatchers("/client.js", "/favicon.ico", "/static/**", "/resources/**", "/socket.io/**", "/web-rtc/**", "/v2/api-docs", "/v1/file/download/**", "/v1/file/upload-base64", "/v1/file/delete-folder/{tenantId}").permitAll()
